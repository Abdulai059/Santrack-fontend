...
export const ROLE_COLORS = {
  ...
  health_officer: { bg: "bg-teal-50", text: "text-teal-700", border: "border-teal-200" },
  ...
  headteacher: { bg: "bg-indigo-50", text: "text-indigo-700", border: "border-indigo-200" },
  community_agent: { bg: "bg-cyan-50", text: "text-cyan-700", border: "border-cyan-200" },
