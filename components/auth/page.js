...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative">
      {/* Simple Background - No Black Overlay */}
      <div
        className={`absolute inset-0 bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 backdrop-blur-sm transition-all duration-300 ${
